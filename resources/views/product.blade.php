                        ...
                        <div class="row">
                                ...
                                <div class="product-gallery product-gallery-vertical">
                                    <div class="row">
                                        <figure class="product-main-image">
                                            ...
                                            <img id="product-zoom" src="{{ $Arrivals[0]['p_image'] }}" data-zoom-image="assets/images/products/single/1-big.jpg" alt="product image">
                                        ...
                                        <div id="product-zoom-gallery" class="product-image-gallery">
                                            <a class="product-gallery-item active" href="#" data-image="assets/images/products/single/1.jpg" data-zoom-image="assets/images/products/single/1-big.jpg">
                                                ...
                                                <img src="{{ $Arrivals[0]['p_image'] }}" alt="product side">
                                            </a>
                                            ...
                                            <a class="product-gallery-item" href="#" data-image="assets/images/products/single/2.jpg" data-zoom-image="assets/images/products/single/2-big.jpg">
                                                ...
                                                <img src="{{ $Arrivals[0]['p_image'] }}" alt="product cross">
                                            </a>
                                            ...
                                            <a class="product-gallery-item" href="#" data-image="assets/images/products/single/3.jpg" data-zoom-image="assets/images/products/single/3-big.jpg">
                                                <img src="{{ $Arrivals[0]['p_image'] }}" alt="product with model">
                                            ...
                                            <a class="product-gallery-item" href="#" data-image="assets/images/products/single/4.jpg" data-zoom-image="assets/images/products/single/4-big.jpg">
                                                ...
                                                <img src="{{ $Arrivals[0]['p_image'] }}" alt="product back">
                                            </a>
                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    <h1 class="product-title">{{ $Arrivals[0]['p_title'] }}</h1><!-- End .product-title -->

                                    <div class="ratings-container">
                                        <div class="ratings">
                                            <div class="ratings-val" style="width: 80%;"></div><!-- End .ratings-val -->
                                        </div><!-- End .ratings -->
                                        <a class="ratings-text" href="#product-review-link" id="review-link">( {{ $Arrivals[0]['p_rating_number'] }} )</a>
                    ...
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                        ...
                        <div class="product product-7 text-center">
                            <figure class="product-media">
                                <span class="product-label label-new">{{ $Arrival->l_primary }}</span>
                                <a href="product.html">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product.html">{{ $Arrival->p_title }}</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    {{ $Arrival->p_price }}
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                                ...
                                <div class="product-nav product-nav-thumbs">
                                    <a href="#" class="active">
                                        <img src="{{ $Arrival->p_image }}" alt="product desc">
