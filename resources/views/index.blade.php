@include('frontend.header.head');
    <div class="page-wrapper">
        ...
        <main class="main">
                    ...
                    <div class="intro-slider owl-carousel owl-simple owl-light owl-nav-inside" data-toggle="owl" data-owl-options='{"nav": false}'>
                        <div class="intro-slide">
                            <figure class="slide-image">
                                <picture>
                                    <source media="(max-width: 480px)" srcset="frontend/assets/images/demos/demo-10/slider/slide-1-480w.jpg">
                                    <img src="frontend/assets/images/demos/demo-10/slider/slide-1.jpg" alt="Image Desc">
                                </picture>
                        ...
                        <div class="intro-slide">
                            <figure class="slide-image">
                                <picture>
                                    <source media="(max-width: 480px)" srcset="frontend/assets/images/demos/demo-10/slider/slide-2-480w.jpg">
                                    <img src="frontend/assets/images/demos/demo-10/slider/slide-2.jpg" alt="Image Desc">
                                </picture>
                            </figure><!-- End .slide-image -->
                        ...
                        <div class="intro-slide">
                            <figure class="slide-image">
                                <picture>
                                    <source media="(max-width: 480px)" srcset="frontend/assets/images/demos/demo-10/slider/slide-3-480w.jpg">
                                    <img src="frontend/assets/images/demos/demo-10/slider/slide-3.jpg" alt="Image Desc">
                                </picture>
                            </figure><!-- End .slide-image -->
                    ...
                    <div class="intro-slider owl-carousel owl-simple owl-light owl-nav-inside" data-toggle="owl" data-owl-options='{"nav": false}'>
                        @foreach ($sliderdata as $slider)
                            <div class="intro-slide">
                                ...
                                <figure class="slide-image @if ($loop->first) active @endif">
                                    <picture>
                                        <source media="(max-width: 480px)" srcset="frontend/assets/images/demos/demo-10/slider/slide-1-480w.jpg">
                                        <img  src="{{asset('storage/slider/' .$slider->slider_img)}} "/>
                                    </picture>
                                </figure><!-- End .slide-image -->

                                <div class="intro-content ">
                                    <h3 class="intro-subtitle">{{ $slider->slider_subtitle }}</h3><!-- End .h3 intro-subtitle -->
                                    <h1 class="intro-title text-white">{{ $slider->slider_title }}</h1><!-- End .intro-title -->
                                    <div class="intro-price text-white">{{ $slider->slider_price }}</div><!-- End .intro-price -->
                                    <a href="category.html" class="btn btn-white-primary btn-round">
                                        <span>{{ $slider->slider_button }}</span>
                                        <i class="icon-long-arrow-right"></i>
                                    </a>
                                </div><!-- End .intro-content -->
                            </div><!-- End .intro-slide -->
                    ...
                    {{-- <div class="row"> --}}
                        {{-- <div class="col-lg-8"> --}}
                                ...
                                @isset($banners)
                                    ...
                                    {{-- <div class="col-sm-6">
                                        <div class="banner banner-overlay">
                                            ...
                                            <div class="banner-content banner-content-right">
                                                <h4 class="banner-subtitle"><a href="#">{{ $banner->banner_subtitle }}</a></h4><!-- End .banner-subtitle -->
                                                <h3 class="banner-title text-white"><a href="#"><h4>{{ $banner->banner_percentage }}</h4></a></h3><!-- End .banner-title -->
                                                <a href="#" class="btn btn-outline-white banner-link btn-round">{{ $banner->banner_type }}</a>
                                    ...
                                    <div class="banner banner-overlay banner-overlay-light">
                                        ...
                                        <div class="banner-content">
                                            <h4 class="banner-subtitle bright-black"><a href="#">{{ $banner->banner_subtitle }}</a></h4><!-- End .banner-subtitle -->
                                            <h3 class="banner-title"><a href="#">{{ $banner->banner_title }}</a></h3><!-- End .banner-title -->
                                            <div class="banner-text"><a href="#">{{ $banner->banner_percentage }}</a></div><!-- End .banner-text -->
                                            <a href="#" class="btn btn-outline-gray banner-link btn-round">{{ $banner->banner_type }}</a>
                                        </div><!-- End .banner-content -->
                                    </div><!-- End .banner -->
                                </div><!-- End .col-sm-6 -->
                                    @endforeach
                            ...
                            {{-- <div class="banner banner-large banner-overlay d-none d-sm-block">
                                <a href="#">
                                    <img src="frontend/assets/images/demos/demo-10/banners/banner-3.jpg" alt="Banner">
                                </a>
                        ...
                        {{-- <div class="col-lg-4 d-sm-none d-lg-block">
                            <div class="banner banner-middle banner-overlay">
                                <a href="#">
                                    <img src="frontend/assets/images/demos/demo-10/banners/banner-4.jpg" alt="Banner">
                                </a>
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="icon-box icon-box-side">
                                        <span class="icon-box-icon text-primary">
                                            <i class="{{ $offer->offer_class }}"></i>
                                        </span>

                                        <div class="icon-box-content">
                                            <h3 class="icon-box-title">{{ $offer->offer_title }}</h3><!-- End .icon-box-title -->
                                            <p>{{ $offer->offer_condition }}</p>
                        ...
                        <div class="tab-pane tab-pane-shadow p-0 fade show active" id="new-all-tab" role="tabpanel" aria-labelledby="new-all-link">
                            <div class="owl-carousel owl-simple carousel-equal-height" data-toggle="owl"
                                    ...
                                    @foreach ($arrivals as $arrival)
                                        <div class="product product-3 text-center">
                                            <figure class="product-media">
                                                <span class="product-label label-primary">{{ $arrival->l_primary }}</span>
                                                <span class="product-label label-sale">{{ $arrival->l_sell }}</span>
                                                <a href="product.html">
                                                    <img src="{{ $arrival->p_image }}" alt="Product image" class="product-image">
                                                </a>
                                            ...
                                            <div class="product-body">
                                                <div class="product-cat">
                                                    <a href="#">{{ $arrival->p_gender }}</a>,
                                                    <a href="#">{{ $arrival->l_primary }}</a>
                                                </div><!-- End .product-cat -->
                                                <h3 class="product-title"><a href="{{ route('product') }}">{{ $arrival->p_title }}</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    <span class="new-price">{{ $arrival->p_n_price }}</span>
                                                    <span class="old-price">{{ $arrival->p_o_price }}</span>
                                            ...
                                            <div class="product-footer">
                                                <div class="ratings-container">
                                                    ...
                                                    <span class="ratings-text">( {{ $arrival->p_rating_number }} )</span>
                                ...
                                {{-- <div class="product product-3 text-center">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="frontend/assets/images/demos/demo-10/products/product-2.jpg" alt="Product image" class="product-image">
                                        </a>
                                ...
                                <div class="product product-3 text-center">
                                    <figure class="product-media">
                                        ...
                                        <a href="product.html">
                                            <img src="frontend/assets/images/demos/demo-10/products/product-3.jpg" alt="Product image" class="product-image">
                                            <img src="frontend/assets/images/demos/demo-10/products/product-3-2.jpg" alt="Product image" class="product-image-hover">
                                        </a>
                                ...
                                <div class="product product-3 text-center">
                                    <figure class="product-media">
                                        ...
                                        <a href="product.html">
                                            <img src="frontend/assets/images/demos/demo-10/products/product-4.jpg" alt="Product image" class="product-image">
                                        </a>
                                ...
                                <div class="product product-3 text-center">
                                    <figure class="product-media">
                                        ...
                                        <a href="product.html">
                                            <img src="frontend/assets/images/demos/demo-10/products/product-5.jpg" alt="Product image" class="product-image">
                                        </a>
                            ...
                            <div class="owl-carousel owl-simple carousel-equal-height" data-toggle="owl"
                                ...
                                <div class="product product-3 text-center">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="{{ route('product') }}">Nike Air Max Motion LW Racer</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            <span class="out-price">$54.99</span>
                                        </div><!-- End .product-price -->
                                    </div><!-- End .product-body -->
                                ...
                                <div class="product product-3 text-center">
                                    <figure class="product-media">
                                        ...
                                        <a href="product.html">
                                            <img src="frontend/assets/images/demos/demo-10/products/product-1.jpg" alt="Product image" class="product-image">
                                        </a>
                            ...
                            <div class="owl-carousel owl-simple carousel-equal-height" data-toggle="owl"
                                ...
                                <div class="product product-3 text-center">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="{{ route('product') }}">ASICS Tiger Gel-Lyte MT</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            <span class="new-price">Now $77.99</span>
                                            <span class="old-price">$130.00</span>
                                        </div><!-- End .product-price -->
            ...
            <div class="container">
                <div class="row justify-content-center">
                        ...
                        @foreach ($TotalProducts as $TotalProduct)
                            <div class="col-sm-6 col-md-4">
                                <div class="banner banner-cat">
                                    <a href="#">
                                        <img src="{{ $TotalProduct->tp_image }}" alt="Banner">
                                    </a>

                                    <div class="banner-content banner-content-overlay text-center">
                                        <h3 class="banner-title font-weight-normal">{{ $TotalProduct->people }}</h3><!-- End .banner-title -->
                                        <h4 class="banner-subtitle">{{ $TotalProduct->total_product }}</h4><!-- End .banner-subtitle -->
                                        <a href="{{ route('category') }}" class="banner-link">SHOP NOW</a>
                                    </div><!-- End .banner-content -->
                                </div><!-- End .banner -->
                            </div><!-- End .col-md-4 -->
                        @endforeach
                    ...
                    {{-- <div class="col-sm-6 col-md-4">
                        <div class="banner banner-cat">
                            <a href="#">
                                <img src="frontend/assets/images/demos/demo-10/banners/banner-6.jpg" alt="Banner">
                            </a>
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="banner banner-cat">
                            <a href="#">
                                <img src="frontend/assets/images/demos/demo-10/banners/banner-7.jpg" alt="Banner">
                            </a>
            ...
            <div class="container">
                            ...
                            <div class="row">
                                    ...
                                    @isset($TopSellings)
                                        ...
                                        <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                            <div class="product product-3 text-center">
                                                <figure class="product-media">
                                                    <span class="product-label label-primary">{{ $TopSelling->l_primary }}</span>
                                                    <span class="product-label label-sale">{{ $TopSelling->l_sell }}</span>
                                                    <a href="product.html">
                                                        <img src="{{ $TopSelling->p_image }}" alt="Product image" class="product-image">
                                                    </a>
                                                ...
                                                <div class="product-body">
                                                    <div class="product-cat">
                                                        <a href="#">{{ $TopSelling->p_gender }}</a>,
                                                        <a href="#">{{ $TopSelling->l_primary }}</a>
                                                    </div><!-- End .product-cat -->
                                                    <h3 class="product-title"><a href="{{ route('product') }}">{{ $TopSelling->p_title }}</a></h3><!-- End .product-title -->
                                                    <div class="product-price">
                                                        <span class="new-price">{{ $TopSelling->p_n_price }}</span>
                                                        <span class="old-price">{{ $TopSelling->p_o_price }}</span>
                                                        {{-- <span class="out-price"></span> --}}
                                                        {{ $TopSelling->p_price }}
                                                    </div><!-- End .product-price -->
                                                </div><!-- End .product-body -->
                                                ...
                                                <div class="product-footer">
                                                    <div class="ratings-container">
                                                        ...
                                                        <span class="ratings-text">( {{ $TopSelling->p_rating_number }} )</span>
                                                    </div><!-- End .rating-container -->
                                ...
                                {{-- <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                    <div class="product product-3 text-center">
                                        <figure class="product-media">
                                            <span class="product-label label-primary">New</span>
                                            <a href="product.html">
                                                <img src="frontend/assets/images/demos/demo-10/products/product-6.jpg" alt="Product image" class="product-image">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                    <div class="product product-3 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="frontend/assets/images/demos/demo-10/products/product-7.jpg" alt="Product image" class="product-image">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                    <div class="product product-3 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="frontend/assets/images/demos/demo-10/products/product-8.jpg" alt="Product image" class="product-image">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                    <div class="product product-3 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="frontend/assets/images/demos/demo-10/products/product-9.jpg" alt="Product image" class="product-image">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                    <div class="product product-3 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="frontend/assets/images/demos/demo-10/products/product-10.jpg" alt="Product image" class="product-image">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                    <div class="product product-3 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="frontend/assets/images/demos/demo-10/products/product-11.jpg" alt="Product image" class="product-image">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                    <div class="product product-3 text-center">
                                        <figure class="product-media">
                                            ...
                                            <a href="product.html">
                                                <img src="frontend/assets/images/demos/demo-10/products/product-12.jpg" alt="Product image" class="product-image">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                    <div class="product product-3 text-center">
                                        <figure class="product-media">
                                            <span class="product-label label-primary">New</span>
                                            <a href="product.html">
                                                <img src="frontend/assets/images/demos/demo-10/products/product-13.jpg" alt="Product image" class="product-image">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                    <div class="product product-3 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="frontend/assets/images/demos/demo-10/products/product-14.jpg" alt="Product image" class="product-image">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                    <div class="product product-3 text-center">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="{{  route('product') }}">Native Shoes Miles Denim Print</a></h3><!-- End .product-title -->
                                            <div class="product-price">
                                                $20.99
                                            </div><!-- End .product-price -->
                                        </div><!-- End .product-body -->
                ...
                <div class="more-container text-center mt-5">
                    <a href="{{  route('category') }}" class="btn btn-outline-lightgray btn-more btn-round"><span>View more products</span><i class="icon-long-arrow-right"></i></a>
            ...
            <div class="container">
                ...
                <div class="cta cta-horizontal cta-horizontal-box bg-image mb-4 mb-lg-6" style="background-image: url(
                    {{ $advertisement->cta_image }} );">
                    <div class="row flex-column flex-lg-row align-items-lg-center">
                        <div class="col">
                            <h3 class="cta-title text-primary">{{ $advertisement->cta_title }}</h3><!-- End .cta-title -->
                            <p class="cta-desc">{{ $advertisement->cta_desc }}</p><!-- End .cta-desc -->
                        </div><!-- End .col -->

                        <div class="col-auto">
                            <a href="#" class="btn btn-white-primary btn-round"><span>{{ $advertisement->cta_cart_price }}</span><i class="icon-long-arrow-right"></i></a>
                        </div><!-- End .col-auto -->
                    </div><!-- End .row -->
            ...
            <div class="blog-posts">
                <div class="container">
                    ...
                    <div class="owl-carousel owl-simple mb-4" data-toggle="owl"
                        ...
                        @foreach($blog as $blog)
                            ...
                            <article class="entry">
                                <figure class="entry-media">
                                    <a href="single.html">
                                    <img src="{{asset('storage/blog/' .$blog->blog_img)}}" >

                                    <!-- <img src="frontend/assets/images/demos/demo-10/blog/post-1.jpg" alt="image desc">  -->
                                    </a>
                                </figure><!-- End .entry-media -->

                                <div class="entry-body text-center">
                                    <div class="entry-meta">
                                        <a href="#">{{$blog->blog_date}}</a>, 0 Comments
                                    </div><!-- End .entry-meta -->

                                    <h3 class="entry-title">
                                        <a href="{{ route('single') }}">{{$blog->blog_title}}</a>
                                    </h3><!-- End .entry-title -->

                                    <div class="entry-content">
                                        <p>{{substr($blog->blog_detail, 0, 100)}} </p>
                        ...
                        {{-- <article class="entry">
                            ...
                            <div class="entry-body text-center">
                                ...
                                <h3 class="entry-title">
                                    <a href="{{ route('single') }}">Sed adipiscing ornare.</a>
                                </h3><!-- End .entry-title -->
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="frontend/assets/images/demos/demo-10/blog/post-2.jpg" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="frontend/assets/images/demos/demo-10/blog/post-3.jpg" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="frontend/assets/images/demos/demo-10/blog/post-4.jpg" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
                    ...
                    <div class="more-container text-center mt-1">
                        <a href="{{ route('blog') }}" class="btn btn-outline-lightgray btn-more btn-round"><span>View more articles</span><i class="icon-long-arrow-right"></i></a>
                    </div><!-- End .more-container -->
                </div><!-- End .container -->
            </div><!-- End .blog-posts -->
        </main><!-- End .main -->
        ...
        <footer class="footer footer-dark">
            <div class="cta bg-image bg-dark pt-4 pb-5 mb-0" style="background-image: url(frontend/assets/images/demos/demo-10/bg-2.jpg);">
                <div class="container">
                    <div class="row justify-content-center">
