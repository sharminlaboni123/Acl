                		...
                		<div class="col-lg-9">
                            <article class="entry single-entry">
                                <figure class="entry-media">
                                    <img src="{{ asset('storage/blog/' .$blog[0]['blog_img']) }}" alt="image desc">
                                ...
                                <div class="entry-body">
                                    <div class="entry-meta">
                                        ...
                                        <a href="#">{{ $blog[0]['blog_comment'] }}</a>
                                        <span class="meta-separator">|</span>
                                        <a href="#">{{ $blog[0]['blog_date'] }}</a>
                                    </div><!-- End .entry-meta -->
                                    
                                    <h2 class="entry-title">
                                        <a href="#">{{ $blog[0]['blog_title'] }}</a>
                                    </h2><!-- End .entry-title -->
                                    ...
                                    <div class="entry-content editor-content">
                                        ...
                                        <img src="{{ asset('storage/blog/' .$blog[0]['blog_img']) }}" alt="image" class="float-left">
                                ...
                                <div class="entry-author-details">
                                    <figure class="author-media">
                                        <a href="#">
                                            <img src="{{ asset('storage/blog/' .$blog[0]['blog_img']) }}" alt="User name">
                                        </a>
                            ...
                            <div class="related-posts">
                                ...
                                <div class="owl-carousel owl-simple" data-toggle="owl" 
                                    ...
                                    <article class="entry entry-grid">
                                        <figure class="entry-media">
                                            <a href="single.html">
                                                <img src="{{ asset('storage/blog/' .$blo->blog_img) }}" alt="image desc">
                                            </a>
                                        </figure><!-- End .entry-media -->
                                            
                                        <div class="entry-body">
                                            <div class="entry-meta">
                                                <a href="#">{{ $blo->blog_date }}</a>
                                                <span class="meta-separator">|</span>
                                                <a href="#">2 Comments</a>
                                            </div><!-- End .entry-meta -->

                                            <h2 class="entry-title">
                                                <a href="single.html">{{ $blo->blog_title }}</a>
                                            </h2><!-- End .entry-title -->
                                ...
                                <div class="widget">
                                    ...
                                    <ul class="posts-list">
                                        ...
                                        <li>
                                            <figure>
                                                <a href="#">
                                                    <img src="{{ asset('storage/blog/' .$blo->blog_img) }}" alt="post">
                                                </a>
                                            </figure>

                                            <div>
                                                <span>{{ $blo->blog_date }}</span>
                                                <h4><a href="#">{{ $blo->blog_title }}</a></h4>
                                            </div>
                                        </li>
                                        @endforeach
...
<!-- molla/single.html  22 Nov 2019 10:04:48 GMT -->
</html>