        ...
        <div class="col-lg-12">
            <div class="card m-b-15">
                <div class="card-header">
                    <h5 class="card-title">Add Offer Advertisement</h5>
                </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-10">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            {{-- <input type="text" class="form-control" name="offer_title" id="inputoffer_title3" placeholder="offer_title"> --}}
                                            <textarea type="text" class="form-control" name="offer_title" id="mytextarea" placeholder="offer_title"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            {{-- <input type="text" class="form-control" name="offer_condition" id="inputoffer_condition3" placeholder="offer_condition"> --}}
                                            <textarea type="text" class="form-control" name="offer_condition" id="mytextarea2" placeholder="offer_condition"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="offer_class" id="inputoffer_class3" placeholder="offer_class">
                                        </div>
                                    </div>
