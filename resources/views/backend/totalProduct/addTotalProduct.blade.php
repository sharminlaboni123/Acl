        ...
        <div class="col-lg-12">
            <div class="card m-b-15">
                <div class="card-header">
                    <h5 class="card-title">Total Product Add From</h5>
                </div>
                    <div class="card-body">
                        <form action="{{ route('addTotalProduct') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-10">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <textarea id="mytextarea" type="text" class="form-control" name="title" id="inputtitle3" placeholder="title"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="people" id="inputpeople3" placeholder="people">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="total_product" id="inputtotal_product3" placeholder="total_product">
                                        </div>
                                    </div>
