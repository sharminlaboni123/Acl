        ...
        <div class="col-lg-12">
            <div class="card m-b-15">
                <div class="card-header">
                    <h5 class="card-title">Edit Banner Advertisement</h5>
                </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-10">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" value="{{ $banner->banner_subtitle }}" name="banner_subtitle" id="inputbanner_subtitle3" placeholder="banner_subtitle">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            {{-- <input type="text" class="form-control" value="{{ $banner->banner_title }}" name="banner_title" id="inputbanner_title3" placeholder="banner_title"> --}}
                                            <textarea type="text" class="form-control" value="{{ $banner->banner_title }}" name="banner_title" id="mytextarea" placeholder="banner_title">></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" value="{{ $banner->banner_percentage }}" name="banner_percentage" id="inputbanner_percentage3" placeholder="banner_percentage">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" value="{{ $banner->banner_type }}" name="banner_type" id="inputbanner_type3" placeholder="banner_type">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <img src="{{ asset($banner->banner_image) }}" alt="" srcset="" height="150px" width="200px">
                                            <input type="hidden" class="form-control" value="{{ $banner->banner_image }}" name="old_image" id="inputold_image3" placeholder="old_image">
                                        </div>
                                    </div>
