<div class="leftbar">
    ...
    <div class="sidebar">
        ...
        <div class="logobar">
            ...
            <h1><a href="{{url('/')}}" class="logo logo-large">ACL</a></h1>
        ...
        <div class="navigationbar">
            <ul class="vertical-menu">
                <li class="vertical-header">Topbar + Menu</li>
                <li>
                    <a href="javaScript:void();">
                      <img src="backend/assets/images/svg-icon/dashboard.svg" class="img-fluid" alt="dashboard"><span>Country</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                        <li><a href="{{ route('country') }}"><i class="mdi mdi-circle"></i>Country</a></li>
                        <li><a href="{{ route('addCountryPage') }}"><i class="mdi mdi-circle"></i>Add Country</a></li>
                    </ul>
                </li>

                <li>
                    <a href="javaScript:void();">
                      <img src="backend/assets/images/svg-icon/dashboard.svg" class="img-fluid" alt="dashboard"><span>Top Menu</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                        <li><a href="{{ route('topMenuPage') }}"><i class="mdi mdi-circle"></i>Top Menu</a></li>
                        <li><a href="{{ route('addTopMenuPage') }}"><i class="mdi mdi-circle"></i>Add Top Menu</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javaScript:void();">
                      <img src="backend/assets/images/svg-icon/dashboard.svg" class="img-fluid" alt="dashboard"><span>Menu</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                        <li><a href="{{ route('mainMenu') }}"><i class="mdi mdi-circle"></i>Main Menu</a></li>
                    </ul>
                </li>

                <li>
                    <a href="javaScript:void();">
                      <img src="backend/assets/images/svg-icon/dashboard.svg" class="img-fluid" alt="dashboard"><span>Sub Menu</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                        <li><a href="{{ route('element') }}"><i class="mdi mdi-circle"></i>Element</a></li>
                        <li><a href="{{ route('menublog') }}"><i class="mdi mdi-circle"></i>Blog</a></li>
                        <li><a href="{{ route('page') }}"><i class="mdi mdi-circle"></i>Page</a></li>
                        <li><a href="{{ route('menuproduct') }}"><i class="mdi mdi-circle"></i>Product</a></li>
                        <li><a href="{{ route('shop') }}"><i class="mdi mdi-circle"></i>Shop</a></li>
                    </ul>
                </li>

                <li class="vertical-header">Body</li>
                <li>
                    <a href="javaScript:void();">
                        <img src="backend/assets/images/svg-icon/layouts.svg" class="img-fluid" alt="layouts"><span>Slider</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                        <li><a href="{{ route('slider.index') }}"><i class="mdi mdi-circle"></i>Slider List</a></li>
                        <li><a href="{{ route('slider.create') }}"><i class="mdi mdi-circle"></i>Add Slider</a></li>
                    </ul>
                </li>

                <li>
                    <a href="javaScript:void();">
                      <img src="backend/assets/images/svg-icon/dashboard.svg" class="img-fluid" alt="dashboard"><span>New Arrival</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                        <li><a href="{{ route('newArrival') }}"><i class="mdi mdi-circle"></i>Arrival</a></li>
                        <li><a href="{{ route('addNewArrivalPage') }}"><i class="mdi mdi-circle"></i>Add Arrival</a></li>
                    </ul>
                </li>

                <li>
                    <a href="javaScript:void();">
                      <img src="backend/assets/images/svg-icon/dashboard.svg" class="img-fluid" alt="dashboard"><span>Top Selling</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                        <li><a href="{{ route('topSelling') }}"><i class="mdi mdi-circle"></i>Top Selling</a></li>
                        <li><a href="{{ route('addTopSellingPage') }}"><i class="mdi mdi-circle"></i>Add Top Selling</a></li>
                    </ul>
                </li>

                <li>
                    <a href="javaScript:void();">
                      <img src="backend/assets/images/svg-icon/dashboard.svg" class="img-fluid" alt="dashboard"><span>Total Product</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                        <li><a href="{{ route('totalProduct') }}"><i class="mdi mdi-circle"></i>Total Product</a></li>
                        <li><a href="{{ route('addTotalProductPage') }}"><i class="mdi mdi-circle"></i>Add Total Product</a></li>
                    </ul>
                </li>

                <li>
                    <a href="javaScript:void();">
                      <img src="backend/assets/images/svg-icon/dashboard.svg" class="img-fluid" alt="dashboard"><span>Advertisement</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                        <li><a href="{{ route('advertisements') }}"><i class="mdi mdi-circle"></i>Advertisement</a></li>
                        <li><a href="{{ route('addAdvertisementPage') }}"><i class="mdi mdi-circle"></i>Add Advertisement</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="vertical-submenu">
                        <li><a href="{{ route('banners') }}"><i class="mdi mdi-circle"></i>Banner</a></li>
                        <li><a href="{{ route('addBannersPage') }}"><i class="mdi mdi-circle"></i>Add Banner</a></li>
                    </ul>
                </li>

                <li>
                    <a href="javaScript:void();">
                      <img src="backend/assets/images/svg-icon/dashboard.svg" class="img-fluid" alt="dashboard"><span>Offer</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                        <li><a href="{{ route('offers') }}"><i class="mdi mdi-circle"></i>Offer</a></li>
                        <li><a href="{{ route('addOffersPage') }}"><i class="mdi mdi-circle"></i>Add Offer</a></li>
                    </ul>
                </li>

                <li class="vertical-header">Footer</li>
                <li>
                    <a href="javaScript:void();">
                        <img src="backend/assets/images/svg-icon/layouts.svg" class="img-fluid" alt="layouts"><span>Footer</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                        <li><a href="{{ route('footer-middle.index') }}"><i class="mdi mdi-circle"></i>Footer List</a></li>
                        <li><a href="{{ route('footer-middle.create') }}"><i class="mdi mdi-circle"></i>Add Footer</a></li>
                    </ul>
                </li>

                <li>
                    <a href="javaScript:void();"><i class="mdi mdi-circle"></i>footer-bottom<i class="feather icon-chevron-right pull-right"></i></a>
                    <ul class="vertical-submenu">
                        <li><a href="{{route('footer_bottom.index')}}"><i class="mdi mdi-circle"></i>footer-bottom List</a></li>
                        <li><a href="{{route('footer_bottom.create')}}"><i class="mdi mdi-circle"></i>Add footer-bottom</a></li>
                    </ul>
                </li>
                ...
                {{-- <li>
                    <a href="javaScript:void();">
                        <img src="backend/assets/images/svg-icon/layouts.svg" class="img-fluid" alt="layouts"><span>Layouts</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                        <li><a href="{{ route('newArrival') }}"><i class="mdi mdi-circle"></i>Arrival</a></li>
                        <li><a href="{{ route('topSelling') }}"><i class="mdi mdi-circle"></i>Top Selling</a></li>
                ...
                <li>
                    <a href="javaScript:void();">
                      <img src="backend/assets/images/svg-icon/apps.svg" class="img-fluid" alt="apps"><span>Apps</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                        <li><a href="{{ route('banners') }}"><i class="mdi mdi-circle"></i>Banner</a></li>
                        <li><a href="{{ route('offers') }}"><i class="mdi mdi-circle"></i>Offer</a></li>
                        <li>
                            <a href="javaScript:void();"><i class="mdi mdi-circle"></i>Menu<i class="feather icon-chevron-right pull-right"></i></a>
                            <ul class="vertical-submenu">
                                <li><a href="{{ route('mainMenu') }}"><i class="mdi mdi-circle"></i>Main Menu</a></li>
                ...
                <li>
                    <a href="{{url('/widgets')}}">
                        <img src="backend/assets/images/svg-icon/widgets.svg" class="img-fluid" alt="widgets"><span>Widgets</span><span class="badge badge-danger pull-right">New</span>
                    </a>
                </li>
                <li class="vertical-header">Components</li>
                <li>
                    <a href="javaScript:void();">
                        <img src="backend/assets/images/svg-icon/basic.svg" class="img-fluid" alt="basic"><span>Basic UI Kits</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="backend/assets/images/svg-icon/advanced.svg" class="img-fluid" alt="advanced"><span>Advanced UI Kits</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="backend/assets/images/svg-icon/form_elements.svg" class="img-fluid" alt="form_elements"><span>Forms Elements</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="backend/assets/images/svg-icon/icons.svg" class="img-fluid" alt="icons"><span>Icons</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="backend/assets/images/svg-icon/chart.svg" class="img-fluid" alt="chart"><span>Charts</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="backend/assets/images/svg-icon/tables.svg" class="img-fluid" alt="tables"><span>Tables</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="backend/assets/images/svg-icon/maps.svg" class="img-fluid" alt="maps"><span>Maps</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="backend/assets/images/svg-icon/ecommerce.svg" class="img-fluid" alt="ecommerce"><span>eCommerce</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="backend/assets/images/svg-icon/pages.svg" class="img-fluid" alt="pages"><span>Basic Pages</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="backend/assets/images/svg-icon/user.svg" class="img-fluid" alt="user"><span>User Pages</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="backend/assets/images/svg-icon/error.svg" class="img-fluid" alt="error"><span>Error Pages</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
