        ...
        <div class="col-lg-12">
            <div class="card m-b-15">
                <div class="card-header">
                    <h5 class="card-title">Posttag List </h5>
                    <a href="{{route('posttag.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add posttag</a>
                ...
                @foreach ($posttag as $posttag)
                  ...
                  <td>{{ $posttag->tag_list}}</td>
                    
                        <td class="d-flex justify-content-center">
                        <a class="btn btn-warning" href="{{ route('posttag.edit', $posttag->id) }}"> Edit </a>
                        <form action="{{ route('posttag.destroy', $posttag->id) }}" method="post" style="display:inline">
                            @csrf
                            @method('delete')
